...
| ---- | ------------- | ---- |
| **[Step 1: Set Up Your Environment](#step-1-of-4-set-up-your-environment)** | Open the dev container (or install .NET 8 + Docker locally) | 5 min |
...
| **[How It Works](#how-it-works)** | Understand the source, the six queries, the synthetic joins, and the C# reaction that streams SSE | 5 min |
