...
| ---- | ------------- | ---- |
| **[Step 1: Set Up Your Environment](#step-1-of-7-set-up-your-environment)** | Open the dev container (or install .NET 8 + Docker locally) | 5 min |
...
| **[How It Works](#how-it-works)** | Understand the sources, the five queries, and the C# reaction | 6 min |
